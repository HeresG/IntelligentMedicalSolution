export const parserMockupTextExample = `
# Titlu Principal h1
## Titlu Secundar h2
### Titlu Secundar h3
#### Titlu Secundar h4
##### Titlu Secundar h5
###### Titlu Secundar h6
Acesta este un paragraf cu **text îngroșat** și o linie nouă.

- Primul element de listă
- Al doilea element de listă

Un alt paragraf simplu.
`;


export const description = `
**Bolile cardiovasculare** reprezintă una dintre principalele cauze de mortalitate la nivel global, afectând inima și vasele de sânge. Aceste afecțiuni pot fi prevenite în mare măsură printr-un stil de viață sănătos, dar necesită atenție și tratament adecvat pentru a preveni complicațiile.
...
- Renunțarea la fumat
###SPACING2###
În concluzie, bolile cardiovasculare pot fi prevenite și tratate eficient printr-o combinație de modificări ale stilului de viață, monitorizare medicală și tratamente adecvate. Menținerea unei inimi sănătoase este cheia unei vieți lungi și active.'
`